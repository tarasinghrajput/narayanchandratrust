  ...
  const getInvoices = async () => {
    ...
    try {
      const res = await fetch("http://localhost:3000/api/invoice/getbyid", {
        ...
        body: JSON.stringify({ hostel: { _id: hostel._id } })
      });
      ...
      if (data.success && Array.isArray(data.invoices)) {
        ...
        toast.error(data.error || "No invoices found", {
          position: "top-right",
          autoClose: 3000,
    ...
    <div className="w-full h-screen flex flex-col gap-3 items-center justify-center">
      ...
      <div className="bg-neutral-950 px-10 py-5 rounded-xl shadow-xl sm:w-[50%] sm:min-w-[500px] w-full mt-5 max-h-96 overflow-auto">
        ...
        {pendingInvoices.length === 0
          ? <span className="text-white text-m">No Students left to generate Invoices for</span>
